...
err := ProcessDocxMulti("contract_template.docx", "completed_contract.docx", batchReplacements)
```
...
ProcessDocxMulti("contract_template.docx", "john_smith_contract.docx", contractData)
```
...
ProcessDocxMultipleRecords("invoice_template.docx", "./invoices", multipleInvoiceData, "invoice_%d.docx")
```
...
ProcessDocxMultipleRecords("invoice_template.docx", "./invoices", multipleInvoiceData, invoiceNamingFunction)
```
...
err = ProcessDocxMulti("template.docx", "output.docx", replacements)
if err != nil {
...
func ProcessLargeDocument(templatePath, outputPath string, data map[string]string) error {
    ...
    return ProcessDocxMulti(templatePath, outputPath, data)
}
```
